...
CREATE TABLE hencore_accpac.dbo.AR_RA (
	...
	BATCHDESC nchar(60) COLLATE Latin1_General_BIN NULL,
	DATEBATCH nchar(12) COLLATE Latin1_General_BIN NULL,
	DATEDEP nchar(12) COLLATE Latin1_General_BIN NULL,
	DATEPOST nchar(12) COLLATE Latin1_General_BIN NULL,
...
INSERT INTO hencore_accpac.dbo.AR_RA (CODEPYMTYP,CNTBTCH,CNTITEM,IDRMIT,IDCUST,DATERMIT,TEXTRMIT,TXTRMITREF,AMTRMIT,AMTRMITTC,CNTPAYMETR,AMTPAYMTC,CODEPAYM,CODECURN,RMITTYPE,DOCTYPE,IDINVCMTCH,CNTLSTLINE,FISCYR,FISCPER,TEXTPAYOR,DATERATETC,AMTRMITHC,DOCNBR,AMTADJHC,OPERBANK,OPERCUST,SRCEAPPL,IDBANK,CODECURNBC,AMTNETTC,COMPANYID,ESTADO,RESULTADO,FECHA,HORA,LOTE,ASIENTO,USUARIO,BATCHDESC,DATEBATCH,DATEDEP,DATEPOST) VALUES
	 (N'CA',1,1,N'91250514                ',NULL,N'05/14/2025  ',N'AR-ID#31996 - Comercial Exportadora SA de CV - Pago de Inter',N'Hencorp Capital CREDITO DIRECTO                             ',215268.750,215268.750,20,215268.750,N'WT          ',N'USD',5,1,NULL,1,N'25  ',N'5 ',N'Comercial Exportadora SA de CV                              ',N'05/14/2025  ',215268.750,NULL,NULL,1,1,N'AR',N'CUSHBCA ',N'USD',215268.750,N'HBCMX          ',NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'HBC-14/05/2025                                              ',N'05/14/2025  ',N'05/14/2025  ',N'05/14/2025  '),
	 (N'CA',1,2,N'91250514                ',NULL,N'05/14/2025  ',N'AR-ID#32376 - SINGUIL de R.L. - Pago de Comision            ',N'Hencorp Capital CREDITO DIRECTO                             ',2600.000,2600.000,20,2600.000,N'WT          ',N'USD',5,1,NULL,1,N'25  ',N'5 ',N'SINGUIL de R.L.                                             ',N'05/14/2025  ',2600.000,NULL,NULL,1,1,N'AR',N'CUSHBCA ',N'USD',2600.000,N'HBCMX          ',NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'HBC-14/05/2025                                              ',N'05/14/2025  ',N'05/14/2025  ',N'05/14/2025  ');
