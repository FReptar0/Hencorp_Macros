...
Begin VB.Form frmReporteAP 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Reporte Macro AP"
   ClientHeight    =   4080
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5220
   Icon            =   "frmReporteAP.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4080
   ...
   End
End
Attribute VB_Name = "frmReporteAP"
...
If OptSinError = True Then
    ssql = "select a.LOTE as lotecreado,a.ASIENTO as asientocreado, * from AP_PA a "
    ssql = ssql & "left outer join AP_MP b on a.CNTBTCH=b.CNTBTCH and a.CNTENTR=b.CNTRMIT and a.COMPANYID=b.COMPANYID "
...
Else
    ...
    ElseIf OptTodos Then
        ssql = ssql & " WHERE (a.DATERMIT  between '" & FechaA & "' AND '" & Fechab & "') and a.COMPANYID='" & Empresa & "' order by a.CNTBTCH,a.CNTENTR"
    End If
End If
    'MsgBox Fechab
Debug.Print ssql
...
If rsDocumentos.EOF = False And rsDocumentos.BOF = False Then
    ...
    '**************************************************************************************************************************************************************
        ...
        .Range("C1").FormulaR1C1 = Empresa & "-Reporte Macro AP"
        ...
        .Range("i3").FormulaR1C1 = "CNTENTR"
        .Range("J3").FormulaR1C1 = "CNTLINE"
        .Range("K3").FormulaR1C1 = "TEXTRMIT"
        .Range("L3").FormulaR1C1 = "NAMERMIT"
        .Range("M3").FormulaR1C1 = "IDBANK"
        .Range("N3").FormulaR1C1 = "IDRMIT"
        .Range("O3").FormulaR1C1 = "DATERMIT"
        .Range("P3").FormulaR1C1 = "BATCHDESC"
        .Range("Q3").FormulaR1C1 = "DATEBATCH"
        .Range("R3").FormulaR1C1 = "DATEPOST"
        .Range("S3").FormulaR1C1 = "REFERECE"
        .Range("T3").FormulaR1C1 = "IDACCT"
        .Range("U3").FormulaR1C1 = "GLREF"
        .Range("V3").FormulaR1C1 = "GLDESC"
        .Range("W3").FormulaR1C1 = "AMTDISTTC"
            ...
            Do While rsDocumentos.EOF = False
                For i = 1 To 23
                    Select Case i
                        ...
                        Case 9
                            .Cells(j, i).Value = "'" & Trim(rsDocumentos!CNTENTR)
                        Case 10
                            .Cells(j, i).Value = "'" & Trim(rsDocumentos!CNTLINE)
                        Case 11
                            .Cells(j, i).Value = "'" & Trim(rsDocumentos!TEXTRMIT)
                        Case 12
                            .Cells(j, i).Value = "'" & Trim(rsDocumentos!NAMERMIT)
                        Case 13
                        ...
                        Case 19
                            .Cells(j, i).Value = "'" & Trim(rsDocumentos!REFERECE)
                        Case 20
